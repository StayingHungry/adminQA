  ...
  <div>
    ...
    <el-row>
      ...
      <el-col :span="12" style="text-align: center">
        ...
        <el-button type="primary" round v-show="Object.keys(fields).length!=0" @click="onConfirmClick" class="confirmBtn">确认</el-button>
      </el-col>
    </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      onConfirmClick(){
        ...
        if (!postData['timestamps'] || !postData['speedMax']){
          this.$notify.error({
            title: '数据异常！',
            message: `未按照要求设置数据！`,
            duration: 2000
        ...
        axios.post('http://127.0.0.1:5000/venusAuto/insertDocuments/',postData)
        .then(res=>{
      ...
      onCancelClick(key){
        console.log('key',key)
        console.log('before del',JSON.stringify(this.fields))
